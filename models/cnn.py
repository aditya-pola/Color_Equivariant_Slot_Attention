...
class CNN(nn.Module):
    ...
    def __init__(
        ...
        self.conv1 = nn.Conv2d(3, planes, kernel_size=5, padding=2)
        self.conv2 = nn.Conv2d(planes, planes, kernel_size=5, padding=2)
        self.conv3 = nn.Conv2d(planes, planes, kernel_size=5, padding=2)
        self.conv4 = nn.Conv2d(planes, planes, kernel_size=5, padding=2)
        self.conv5 = nn.Conv2d(planes, planes, kernel_size=5, padding=2)
        self.conv6 = nn.Conv2d(planes, planes, kernel_size=5, padding=2)
        self.conv7 = nn.Conv2d(planes, planes, kernel_size=5, padding=2)
...
if __name__ == "__main__":
    ...
    planes = 20
    # summary(CNN(planes=planes), (8, 3, 128, 128), device="cpu")
